        ...
        >
          <Form className="space-y-4">
            ...
            <div className="text-sm">
              <a
                href="/sign-in"
                className="font-medium text-gray-600 hover:text-gray-900 focus:outline-none focus:rounded-sm focus:ring-2 focus:ring-gray-700"
              >
                Have an account?
              </a>
            </div>
            ...
            <div className="flex flew-row space-x-4">
              <button
                type="button"
                className="inline-flex items-center w-full justify-center py-3 px-4 text-sm font-medium rounded-md shadow-md text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-700"
                onClick={() => {
                  navigate(-1);
                }}
              >
